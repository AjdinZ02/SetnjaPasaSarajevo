...
namespace SetnjaPasaSarajevo.Services
{
        ...
        where TSearch : BaseSearchObject
    {
        ...
        protected BaseCRUDService(SetnjaPasaSarajevoDbContext dbContext, MapsterMapper.IMapper mapper, IValidator<TInsertRequest> insertValidator, IValidator<TUpdateRequest> updateValidator) : base(mapper, dbContext)
        {
